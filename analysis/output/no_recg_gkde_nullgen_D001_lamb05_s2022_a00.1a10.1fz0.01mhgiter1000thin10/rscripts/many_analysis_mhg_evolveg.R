...
run.name <- 'no_recg_gkde_nullgen_D001_lamb05'
...
run.name <- 'no_recg_gkde_gamma_D001_lamb05'
run_it(rng.seed, run.name, dat, kernel.a0, kernel.a1, kernel.fuzz, mhg.iter, mhg.thin)
...
run.name <- 'no_recg_gkde_beta_D001_lamb05'
run_it(rng.seed, run.name, dat, kernel.a0, kernel.a1, kernel.fuzz, mhg.iter, mhg.thin)
...
run.name <- 'no_recg_gkde_betaassym_D001_lamb05'
run_it(rng.seed, run.name, dat, kernel.a0, kernel.a1, kernel.fuzz, mhg.iter, mhg.thin)
