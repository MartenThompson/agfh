...
run.name <- 'no_recthv_gkde_nullgen_D01_lamb5'
...
run.name <- 'no_recthv_gkde_gamma_D01_lamb5'
run_it(rng.seed, run.name, dat, kernel.a0, kernel.a1, kernel.fuzz, mhg.iter, mhg.thin)
...
run.name <- 'no_recthv_gkde_beta_D01_lamb5'
run_it(rng.seed, run.name, dat, kernel.a0, kernel.a1, kernel.fuzz, mhg.iter, mhg.thin)
...
run.name <- 'no_recthv_gkde_betaassym_D01_lamb5'
run_it(rng.seed, run.name, dat, kernel.a0, kernel.a1, kernel.fuzz, mhg.iter, mhg.thin)
